...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/nested-lookup-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11834&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/nested-lookup-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `nested-lookup` can be installed with:

```
conda install nested-lookup
```

It is possible to list all of the versions of `nested-lookup` available on your platform with:
